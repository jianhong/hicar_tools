...
|-------|-----------|---------|---------|-------|-------|
| WT | 1 | fastq/WT1_R1.fastq.gz| fastq/WT1_R2.fastq.gz |  |  |
| WT | 2 | fastq/WT2_R1.fastq.gz| fastq/WT2_R2.fastq.gz |  |  |
| KD | 1 | fastq/KD1_R1.fastq.gz| fastq/KD1_R2.fastq.gz |  |  |
| KD | 2 | fastq/KD2_R1.fastq.gz| fastq/KD2_R2.fastq.gz |  |  |
