...
class Schema {
    ...
    */
    ...
    private static LinkedHashMap params_summary(workflow, params, run_name) {
        ...
        summary['deepTools Genome Size']  = params.deep_gsize ?: 'Not supplied'
        summary['UCSC Assembly Name']     = params.species
        summary['Autosomal Number']       = params.autosomal
        summary['MACS2 shiftsize ATAC']   = params.shiftsize
        summary['MACS2 extsize ATAC']     = params.smooth_window
        summary['MACS2 q-value ATAC']     = params.qval_thresh
        summary['Resolution']             = params.cool_bin
        ...
        if (params.skip_trackhub)         summary['Skip trackhub'] = 'Yes'
    ...
    static String params_mqc_summary(summary) {
        ...
        section_name: 'nf-core/hicar Workflow Summary'
        section_href: 'https://github.com/jianhong/hicar'
        plot_type: 'html'
        data: |
